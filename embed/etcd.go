...
import (
	...
	"github.com/appian/etcd/etcdserver/api/v2v3"
	...
	runtimeutil "github.com/appian/etcd/pkg/runtime"
...
var plog = capnslog.NewPackageLogger("github.com/appian/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// and https://github.com/appian/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
